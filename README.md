...
2) A small portion (about 2.5 acres) will transition to carbon-negative agroforestry and habitat.  This may eventually lead to the production of hardware components for agroforestry systems along with sales of high-value hardwoods (oak, walnut, maple) as well as fruit, nut, and hardwood tree saplings.   
